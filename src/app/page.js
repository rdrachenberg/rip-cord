...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-24 bg-gradient-to-r from-slate-300 to-slate-500 ">
      ...
      <div className='rounded-xl p-1 mt-3 bg-gradient-to-l from-cyan-300 to-blue-700'>
        <div className='max-w-lg sm:min-w-[600px] min-h-screen mx-auto p-8 rounded-xl  text-xl bg-white `rounded-[calc(1.5rem-1px)]` '>
        {signer ? (
          <div>
            <div className='text-black'>Connected Address: {signer.address}</div>
